...
<div class="container-xxl bg-white p-0">
    ...
    <div class="container-fluid p-0 mb-5">
        <div class="imgTest">
            <img class="img-fluid background" src="/img/IDOmainBackground.png" style="z-index: 1;"alt="">
            <div id="input-box" style="z-index: 5;">
                <form id="f">
                    <div id="heading" style="margin-top: 15px; width: 250px; height: 45px; flex-shrink: 0; border-radius: 50px; border: none; font-family: 'TmoneyRoundWindExtraBold';"> 아이디 찾기 </div>
                    <div class="login-input">
                        <input name="userName" placeholder="이름을 입력해주세요" id="userId" type="text" style="width:250px; height: 50px; padding-bottom: 7px; border-radius:10px; border: none; font-family: 'TmoneyRoundWindExtraBold'; ">
                        <br>
                        <input name="email" placeholder="이메일을 입력해주세요" id="email" type="text" style="width:250px; height: 50px; padding-bottom: 7px; border-radius:10px; border: none; font-family: 'TmoneyRoundWindExtraBold'; margin-top: 10px; "></div>
                    <button id="btnSearchUserId" type="button" style=" color: white; margin-top: 15px; width: 250px; height: 45px; flex-shrink: 0; border-radius: 50px; border: none; background: #0d6efd; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25); font-family: 'TmoneyRoundWindExtraBold';">아이디 찾기</button>
                </form>
                <div id="forgot">
                    <span class="forgotId" style="font-family: 'TmoneyRoundWindExtraBold';">이미 계정이 있으신가요?</span>
                    <a href="/user/login"> <span class="forgotId" style="font-family: 'TmoneyRoundWindExtraBold';">로그인하기</span></a>
